...
[SerializeField]
public class BlueFireTileEffect : tileEffectActions
{
    ...
    public override void performEndOfTurnEffect(ClickableTile tile){
        if (tile.GetComponent<ClickableTile>().characterOnTile != null){
            UnityEngine.Debug.Log("It will burn down");
    ...
    */
    ...
    public override void performStepOnEffect(ClickableTile tile){
        tile.characterOnTile.GetComponent<Basic_Character_Class>().takeMagicDamage(4, "Fire");
    }
}
